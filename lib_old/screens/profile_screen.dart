...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    final loadedName = savedName ?? 'Habit Gardener';

    setState(() {
      _name = loadedName;
      _nameController.text = loadedName == 'Habit Gardener' ? '' : loadedName;
  ...
  Future<void> _pickProfileImage() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Could not select the image.')),
      );
    }
  }
  ...
  void _cancelEditingName() {
    setState(() {
      _nameController.text = _name == 'Habit Gardener' ? '' : _name;
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Growing better habits every day',
                    style: TextStyle(
